...
//
// read_two_codes.cpp — reader for the lane-parallel bp16 placement example. NoC-reads the
// CODE_A tile into cb_a and the CODE_B tile into cb_b. One page == one tile.
